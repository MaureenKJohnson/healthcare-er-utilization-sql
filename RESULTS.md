...
Across insurance groups, average emergency department (ED) utilization ranged from 3.09 to 4.04 visits per patient. Self-Pay patients demonstrated the highest average number of ER visits (4.04 visits per patient), while Medicaid patients demonstrated the lowest overall utilization (3.09 visits per patient). Patients with Commercial insurance, Medicare Advantage, and Medicare exhibited intermediate utilization levels, averaging approximately 3.43, 3.51, and 3.77 ER visits per patient, respectively.

These descriptive differences suggest variation in utilization patterns across payer groups; however, no inferential testing was performed to assess the statistical significance of these differences.
